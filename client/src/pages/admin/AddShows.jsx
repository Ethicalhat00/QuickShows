...
import { CheckIcon, DeleteIcon, StarIcon, Trash2 } from "lucide-react";
import { kCoverter } from "../../lib/kCoverter";
...
const AddShows = () => {
  ...
  const fecthNowPlayingMovies = async () => {
    try {
      ...
      console.log("erroe fetch movies :",error);
  ...
  const handleSubmit=async () => {
    try {
      ...
      console.error("submiison error",error)
      toast.error('eAn error occured plaese try again ')
    }
    setAddingShow(false)
  }
